...
function Maps() {
  ...
  useEffect(() => {
    if (!map) {
      ...
      // ระยะทางในแต่ละทิศ
      const distanceNorth = 2000;
      const distanceNorth2 = 2200;
      const distanceNortheast = 2500;
      const distanceNortheast2 = 4000;

      const distanceEast = 8000;
      const distanceEast2 = 8000;
      const distanceSoutheast = 8000;
      const distanceSoutheast2 = 5000;

      const distanceSouth = 1500;
      const distanceSouth2 = 1200;
      const distanceSouthwest = 1000;
      const distanceSouthwest2 = 1500;

      const distanceWest = 1500;
      const distanceWest2 = 1500;
      const distanceNorthwest = 1500;
      const distanceNorthwest2 = 1500;
